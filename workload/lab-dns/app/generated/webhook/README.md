...
- API version: v0.15.0
- Build date: 2025-01-02T21:06:58.330048238Z[Etc/UTC]
...
This autogenerated project defines an API crate `webhook` which contains:
...
#[async_trait]
impl webhook::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = webhook::server::new(Arc::new(ServerImpl));
